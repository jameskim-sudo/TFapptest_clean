...
import imgGeminiGeneratedImageYt4Drtyt4Drtyt4D from "figma:asset/a69967323cbe77265989fdbc93ba9164d70539ee.png";
    ...
    <div className="absolute h-[158px] left-[116px] overflow-clip top-[162px] w-[127px]" data-name="B">
      <div className="absolute h-[160.593px] left-[calc(50%+0.23px)] top-[-3px] translate-x-[-50%] w-[133.451px]" data-name="Gemini_Generated_Image_yt4drtyt4drtyt4d">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[100.13%] left-[-5.39%] max-w-none top-0 w-[191.22%]" src={imgGeminiGeneratedImageYt4Drtyt4Drtyt4D} />
        </div>
      </div>
    </div>
  );
