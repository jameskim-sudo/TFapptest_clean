import svgPaths from "./svg-2p1hjomycv";
...
function Frame2() {
  return (
    <div className="[grid-area:1_/_1] content-stretch flex items-start ml-0 mt-0 relative">
      <p className="font-['Pretendard:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-white tracking-[-0.5px] whitespace-pre">운동 기록 시작하기</p>
      <Icon />
    </div>
  );
}
...
export default function Component360X() {
  return (
    <div className="bg-white relative size-full" data-name="360x640">
      ...
      <StatusBar />
      <Group2 />
      <div className="absolute flex flex-col font-['Pilseung_Gothic:Basic',sans-serif] justify-center leading-[0] left-1/2 not-italic text-[#ff482c] text-[25px] text-center top-[404px] tracking-[1px] translate-x-[-50%] translate-y-[-50%] whitespace-nowrap">
      ...
      <p className="absolute font-['Pretendard:Medium',sans-serif] leading-[18px] left-[calc(50%+0.5px)] not-italic text-[#292929] text-[12px] text-center top-[592px] tracking-[-0.5px] translate-x-[-50%] whitespace-pre">
        ...
        <span className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid font-['Pretendard:Bold',sans-serif] text-[#ff482c] underline">로그인</span>
      </p>
    </div>
  );
}