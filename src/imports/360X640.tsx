import svgPaths from "./svg-y2keatjttf";

function Group() {
  return (
    <div className="absolute h-[85px] left-[127px] top-[257px] w-[106.074px]">
...
export default function Component360X() {
  return (
    <div className="bg-white relative size-full" data-name="360x640">
      <Group />
      <div className="absolute flex flex-col font-['Pilseung_Gothic:Basic',sans-serif] justify-center leading-[0] left-[calc(50%-53px)] not-italic text-[#ff482c] text-[29.041px] top-[362.5px] tracking-[1.4521px] translate-y-[-50%] whitespace-nowrap">
